...
const frameworks: Framework[] = [
  {
    name: "React",
    icon: siReact,
    philosophy: "The most widely used, so the most jobs, tutorials, and ready-made pieces. You build from components and add routing and data-fetching yourself (or reach for Next.js).",
  ...
  },
  {
    name: "Next.js",
    icon: siNextdotjs,
    philosophy: "React plus the parts it leaves out: routing based on your file structure, server rendering for speed and search engines, and backend code in the same project. It is what this site is built with.",
  ...
  },
  {
    name: "Vue",
    icon: siVuedotjs,
    philosophy: "Known for a gentle learning curve and unusually clear docs. A common first framework.",
  ...
  },
  {
    name: "Nuxt.js",
    icon: siNuxt,
    philosophy: "Vue's answer to Next.js: file-based routing, server rendering, and less setup to wire together.",
  ...
  },
  {
    ...
    philosophy: "Everything in one box, routing, forms, and data handling, with firm conventions. More to learn up front, less to assemble yourself. Common at large companies.",
    ...
    <div className="flex flex-col gap-8 text-sm lg:text-base">
      ...
      <div>
        <div className="flex items-center justify-between mb-4">
          ...
          <span className="text-xs text-zinc-400 dark:text-zinc-500">Last reviewed July 2026</span>
        </div>
      ...
      <div className="text-sm lg:text-base text-zinc-600 dark:text-zinc-400 space-y-3">
        ...
        <p>
          ...
          They all solve the same core problems in different ways; what varies is
          how much code they ship, how much there is to learn, how big the
          community is, and how many decisions the framework makes for you.
        </p>
        <p>
          There is no single &ldquo;best&rdquo;. Pick one, learn it well, and the
          concepts will transfer when you try another.
        </p>
      </div>
    </div>
  );
