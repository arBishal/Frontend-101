...
const problems = [
  ...
  },
  {
    ...
    description: "Build a button once, use it everywhere.",
  },
  {
    icon: Route,
    ...
    <div className="flex flex-col gap-8 text-sm lg:text-base">
      ...
      <div className="text-muted space-y-3 text-sm lg:text-base">
        ...
        <p>
          ...
          that one. A framework is like getting in and saying “take me to the
          airport.” You say where you want to end up, and it handles the route.
        </p>
        <p>
          ...
          <em className="text-body">how</em> to change the page step by step,
          you describe <em className="text-body">what</em> it should look like,
          and the framework works out the steps.
        </p>
      </div>
      ...
      <div className="text-muted space-y-3 text-sm lg:text-base">
        ...
        <p>
          ...
          entire site runs on <strong className="text-strong">Next.js</strong>,
          which is built on <strong className="text-strong">React</strong>.
        </p>
        <ProblemCards problems={problems} className="gap-4 sm:grid-cols-2" />
        <Takeaway>
