  ...
  return (
    <div className="w-full max-w-lg rounded-lg border border-zinc-200 dark:border-zinc-800 overflow-hidden">
      ...
      <div className="flex items-center gap-2 px-4 py-3 bg-zinc-100 dark:bg-zinc-900 border-b border-zinc-200 dark:border-zinc-800">
        ...
        <div className="flex-1 h-5 rounded-xs bg-zinc-200 dark:bg-zinc-800 mx-8" />
      </div>
      {/* Content */}
      <div className="p-3 sm:p-4 bg-white dark:bg-zinc-950 flex gap-3">
        {/* Sidebar */}
        <div className="w-10 sm:w-14 shrink-0 space-y-3 pt-1">
          <div className="h-2 w-8 sm:w-10 rounded-full bg-zinc-300 dark:bg-zinc-700" />
          <div className="h-2 w-6 sm:w-8 rounded-full bg-zinc-200 dark:bg-zinc-800" />
          <div className="h-2 w-7 sm:w-12 rounded-full bg-zinc-200 dark:bg-zinc-800" />
          <div className="h-2 w-5 sm:w-9 rounded-full bg-zinc-200 dark:bg-zinc-800" />
        </div>
        {/* Main */}
        <div className="flex-1 space-y-3 min-w-0">
          ...
          <div className="grid grid-cols-3 gap-2">
            {[1, 2, 3].map((i) => (
              ...
              >
                <div className="h-2 w-6 rounded-full bg-zinc-200 dark:bg-zinc-800" />
                <div className="h-3 w-8 rounded-full bg-zinc-300 dark:bg-zinc-700" />
              </div>
            ))}
          </div>
          {/* Table */}
          <div className="rounded-sm bg-zinc-50 dark:bg-zinc-900 border border-zinc-200 dark:border-zinc-800 overflow-hidden">
            <div className="px-3 py-2 bg-zinc-100 dark:bg-zinc-800/50 flex gap-4">
              <div className="h-2 w-12 rounded-full bg-zinc-300 dark:bg-zinc-700" />
              <div className="h-2 w-10 rounded-full bg-zinc-300 dark:bg-zinc-700 hidden sm:block" />
              <div className="h-2 w-8 rounded-full bg-zinc-300 dark:bg-zinc-700 ml-auto" />
            </div>
            {[1, 2, 3, 4].map((i) => (
              <div
                key={i}
              ...
              >
                <div className="h-2 w-14 rounded-full bg-zinc-200 dark:bg-zinc-800" />
                <div className="h-2 w-10 rounded-full bg-zinc-200 dark:bg-zinc-800 hidden sm:block" />
                <div className="h-2 w-6 rounded-full bg-zinc-200 dark:bg-zinc-800 ml-auto" />
              </div>
            ))}
          </div>
        </div>
    ...
    <main className="min-h-screen flex flex-col items-center justify-center p-6 overflow-hidden">
      ...
      <div className="h-dvh flex flex-col items-center justify-center text-center max-w-4xl gap-3 md:gap-4">
        <div className="animate-fade-in-up font-mono text-sm md:text-base inline-flex items-center gap-2">
          ...
          <span className="bg-linear-to-r from-zinc-500 to-zinc-400 dark:from-zinc-400 dark:to-zinc-600 bg-clip-text text-transparent">npx frontend-101</span>
        </div>
        ...
        <p className="animate-fade-in-up anim-delay-300 max-w-md text-lg md:text-xl text-zinc-500 dark:text-zinc-400">
      ...
      <div className="relative w-full max-w-4xl">
        <p className="font-mono text-base md:text-lg text-zinc-400 font-light dark:text-zinc-600 mb-4 text-center uppercase tracking-widest">
          What&apos;s covered
        </p>
      ...
      <div className="relative w-full max-w-4xl mt-24 flex flex-col items-center text-center">
        <p className="font-mono text-base md:text-lg text-zinc-400 font-light dark:text-zinc-600 mb-4 uppercase tracking-widest">
          What&apos;s next
        </p>
        <h2 className="text-2xl md:text-3xl font-bold text-zinc-900 dark:text-zinc-50">
          How to Approach a Component
        </h2>
        <p className="mt-2 text-base md:text-lg text-zinc-500 dark:text-zinc-400 max-w-md">
        ...
        <div className="mt-8 w-full max-w-sm">
          <div className="rounded-lg border border-zinc-200 dark:border-zinc-800 overflow-hidden">
            ...
            <div className="flex items-center gap-3 px-4 py-3 bg-white dark:bg-zinc-950">
              ...
              <div className="h-3 w-24 rounded-full bg-zinc-300 dark:bg-zinc-600" />
              <div className="h-3 w-3 rounded-full bg-zinc-200 dark:bg-zinc-700 ml-auto" />
            </div>
            {/* Suggestion rows */}
            {[1, 2, 3].map((i) => (
              <div
        ...
        <span className="mt-6 inline-block rounded-full border border-zinc-200 dark:border-zinc-800 px-4 py-1.5 text-xs font-medium text-zinc-400 dark:text-zinc-500 uppercase tracking-wider">
          Coming soon
        </span>
      </div>

      <div className="relative mt-16 text-center text-sm md:text-base text-zinc-500 dark:text-zinc-400">
        <p>
